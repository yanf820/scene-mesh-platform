...
public class ActionToolDrawingLoader implements IToolDrawingLoader {
    ...
    public ActionToolDrawingLoader(IMetaActionService metaActionService) {
        this.metaActionService = metaActionService;
    }

    @Override
    public List<IMetaAction> loadToolDrawings() {
        return this.metaActionService.getAllMetaActions();
    }
}
